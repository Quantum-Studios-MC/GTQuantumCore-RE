...
public class SteamGlassFurnace extends GTQuantumCoreRecipeMapSteamMultiblockController {

    public SteamGlassFurnace(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, RecipeMapsHandler.GLASS_FURNACE, CONVERSION_RATE);
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .where('F', states(getCasingState()).setMinGlobalLimited(18).or(autoAbilities())
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new SteamGlassFurnace(metaTileEntityId);
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World player, List<String> tooltip, boolean advanced) {
        ...
        tooltip.add(I18n.format("gtquantumcore.multiblock.glass_furnace.description"));
        tooltip.add(I18n.format("gtquantumcore.multiblock.glass_furnace.usage"));
