...
public class SteamBriquetteFurnace extends GTQuantumCoreRecipeMapSteamMultiblockController {

    private int parallelLimit = 16;

    public SteamBriquetteFurnace(ResourceLocation metaTileEntityId) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new SteamBriquetteFurnace(metaTileEntityId);
    }
