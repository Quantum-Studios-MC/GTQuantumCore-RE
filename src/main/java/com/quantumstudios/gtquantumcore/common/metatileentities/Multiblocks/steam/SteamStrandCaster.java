...
public class SteamStrandCaster extends GTQuantumCoreRecipeMapSteamMultiblockController {
    ...
    private int parallelLimit = 4; // Starting with 4 base
    ...
    private void updateBellowEffects() {
        ...
        parallelLimit = 4; // Base parallel limit (starts with 4)
    ...
    protected void addDisplayText(List<ITextComponent> textList) {
        ...
        if (isStructureFormed() && parallelLimit > 4) {
    ...
    protected BlockPattern createStructurePattern() {
        return FactoryBlockPattern.start()
                ...
                .aisle("FFFFF", "F###F", "F###F")
                .aisle("SFFFF", "FFFFF", "FFFFF")
                .where('S', selfPredicate())
                .where('F', states(getCasingState()).setMinGlobalLimited(10).or(autoAbilities())
